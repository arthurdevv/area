...
function FeatureItem({ index, description }: FeatureItemProps) {
  return (
    <li className="tablet:pr-20 tablet:h-auto border-divider flex h-15 min-h-fit gap-7.5 border-t py-5 text-[0.9375rem] leading-[140%]">
      ...
      >
        <div className="flex flex-col gap-10">
          <div className="tablet:pr-20 relative flex flex-col gap-10">
            ...
            <h2 className="desktop:text-[3.75rem] tablet:text-[3.375rem] font-crimson mt-15 text-[3.125rem] leading-[100%] tracking-[-0.01em]">
              See the Big Picture
            </h2>
