...
export default function Hero() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="tablet:px-0 desktop:max-w-375 tablet:gap-35 desktop:gap-60 flex w-full flex-col gap-30 px-4 pt-37.5 text-center"
    >
      ...
      >
        <Image
          ...
          width={907}
          height={644}
          className="desktop:h-132.5 tablet:block tablet:h-125 tablet:w-177.5 hidden h-auto w-auto"
        />
        <Image
          src="/iphone.svg"
          alt="iPhone"
